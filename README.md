...
**This version is deprecated and will only receive critical bugfixes from the maintainers.**

**We encourage you to switch for version 1.0 which is based on Spring Boot 2.**
